$(document).ready(function(){
    ...
    for (let i = 1; i <= 3; i++) {
        ...
        link.href="../stranice_srpski/ostale"+i+".html";
        ...
        if(i==1){
            link.innerHTML="<br>Насукана трсатска сирена</a>";
            paragraf.innerHTML="Надежда Ђукановић Пантелић&hellip;";
            clan.id="Nadezda Nasukana";
            artikal.id="Nadezda Djukanovic Pantelic nadežda đukanović pantelić Насукана трсатска сирена Надежда Ђукановић Пантелић nasukana trsatska sirena";
        }
        else if(i==2){
            link.innerHTML="<br>Камени тањир азбука</a>";
            paragraf.innerHTML="Надежда Ђукановић Пантелић&hellip;";
            clan.id="Nadezda Kameni";
            artikal.id="Nadezda Djukanovic Pantelic nadežda đukanović pantelić kameni tanjir azbuka Надежда Ђукановић Пантелић Камени тањир азбука";
        }
        else{
            link.innerHTML="<br>Деда мраз</a>";
            paragraf.innerHTML="Томас Наст&hellip;";
            clan.id="Tomas Deda";
            artikal.id="tomas nast deda mraz томас наст деда мраз";
