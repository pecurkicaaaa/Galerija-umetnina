$(document).ready(function(){
  ...
  for (let i = 1; i <= 3; i++) {
      ...
      link.href="../stranice_srpski/slika"+i+".html";
      ...
      if(i==1){
          link.innerHTML="<br>Девојка с бисерном минђушом</a>";
          paragraf.innerHTML="Јоханес Вермер&hellip;";
          clan.id="Johan Devojka";
          artikal.id="Devojka sa bisernom mindjusom Johanes vermer Девојка с бисерном минђушом Јоханес Вермер minđušom";
      }
      else if(i==2){
          link.innerHTML="<br>Пољубац</a>";
          paragraf.innerHTML="Густав Климт&hellip;";
          clan.id="Gustav Poljubac";
          artikal.id="Poljubac Gustav klimt Пољубац Густав Климт";
      }
      else{
          link.innerHTML="<br>Мона лиза</a>";
          paragraf.innerHTML="Леонардо да Винчи&hellip;";
          clan.id="Leo Mona";
          artikal.id="Mona liza Leonardo da vinci мона лиза леонардо да винчи vinči";
      }
